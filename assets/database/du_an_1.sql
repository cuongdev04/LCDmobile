...
--
-- Host: localhost:3306
-- Generation Time: Aug 01, 2024 at 01:06 AM
...
(3, 18, 'banner3.webp', '2024-02-08'),
(4, 19, 'banner2.webp', '2024-02-08'),
(5, 26, 'banner5.webp', '2024-02-08');
...
(29, 1, 27, 'Điện thoại đẹp quá tuyệt vời', '2024-08-01');
...
(162, 111, 9, 2, 11333000, 22666000),
(163, 112, 26, 1, 32792000, 32792000);
...
(111, 1, 'Nguyễn Văn Cường', '2024-07-25 08:03:26', 'Phù Lưu ,Ứng Hòa ,Hà Nộiii', '0964426518', 0, 5, 0),
(112, 26, 'Nguyễn Văn Cường', '2024-07-25 14:22:05', 'Phù Lưu , Ứng Hòa , Thành Phố Hà Nội', '0343433434', 0, 4, 1);
...
(1, 'Nguyễn Văn Cường', 'cuongnvph36558@fpt.edu.vn', '0123456789', 'Tôi muốn được hướng dẫn', '2024-02-08 20:53:25');
...
(1, 'Nguyễn Văn Cường', 'cuongvnph36558', 'Cuong2004', 'cuongvnph36558@fpt.edu.vn', '0964426518', 'Phù Lưu ,Ứng Hòa ,Hà Nội', 1, 0),
(2, 'Ngô Đình Dũng', 'dungndph37440', 'Dung2004', 'dungndph37440@fpt.edu.vn', '0357864779', 'Hà Nội', 1, 0),
(3, 'Trần Văn Lương', 'Luong2004', 'Luong2004', 'luong51024@gmail.com', '0389119333', 'Phú Thọ', 1, 0),
(25, 'Dương Thế Tuấn', 'tuanbacninh', 'Tuanbacninh123', 'tuanbacninh@gmail.com', '0123456789', 'Trịnh Văn Bô, Bắc Từ Liêm', 0, 0),
(26, 'Nguyễn Văn Cường', 'cuongvipvip', 'Cuong11111_', 'vds@gmail.com', '', '', 0, 0);
...
(4, '2024-08-01', 4, '48000000', 4),
(5, '2024-08-01', 2, '30000000', 2),
(6, '2024-08-01', 5, '100000000', 8),
(7, '2024-08-01', 3, '90434000', 6),
(11, '2024-08-01', 3, '69605000', 7),
(12, '2024-08-01', 1, '65240000', 5),
(13, '2024-08-01', 3, '29240000', 5),
(18, '2024-08-02', 2, '45805000', 2),
(19, '2024-08-02', 6, '148988000', 12),
(20, '2024-07-30', 3, '61941000', 5);
...
--
ALTER TABLE `chitietdonhang`
  ADD CONSTRAINT `fk_ct_dh` FOREIGN KEY (`iddonhang`) REFERENCES `donhang` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `donhang`
  ADD CONSTRAINT `fk_dh_tk` FOREIGN KEY (`idtaikhoan`) REFERENCES `taikhoan` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
