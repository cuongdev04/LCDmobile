    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?act=trangchu">
                ...
                <div class="sidebar-brand-text mx-3">LCD MOBILE</div>
            </a>
            ...
            if ($count_dh_kiemduyet['COUNT(*)'] > 0) {
                $sup = '<i class="fas fa-fw fa-circle" style="color: red;"></i>';
            } else {
                $sup = '';
            }
            ?>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $_SESSION['user']['hovaten'] ?></span>
