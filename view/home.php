<div class="slider-area">
    <div class="slider-active swiper-container">
        <div class="swiper-wrapper">
            <?php foreach ($list_banner_home as $banner) : ?>
                <?php extract($banner);?>  
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="hero-slider-img-1 slider-animated-1">
                                    <img class="animated animated-slider-img-1" src="../uploads/banner/<?= $imagebanner;?>" alt="">
                                    <div class="product-offer animated">
                                        <h5><?= $khuyenmai; ?>% <span>Off</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrap mb-30" data-aos="fade-up" data-aos-delay="<?= $delay?>">
                            <div class="blog-img-date-wrap mb-25">
                                <div class="blog-img">
                                    <a href="#"><img src="../uploads/tintuc/<?= $image?>" alt=""></a>
                                </div>
                                <div class="blog-date">
                                    <h5><?= $ngaydang?></h5>
                                </div>
