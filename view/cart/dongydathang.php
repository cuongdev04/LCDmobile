                                ...
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input type="text" name="hovaten"
                                            value="<?= isset($hovaten) ? $hovaten : $_SESSION['user']['hovaten'] ?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input type="text" name="sodienthoai"
                                            value="<?= isset($sodienthoai) ? $sodienthoai : $_SESSION['user']['sodienthoai'] ?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input type="text" name="diachi"
                                            value="<?= isset($diachi) ? $diachi : $_SESSION['user']['diachi'] ?>">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="billing-info mb-20">
                                                ...
                                                <input type="text" name="hovatennhan"
                                                    value="<?= isset($hovatennhan) ? $hovatennhan : '' ?>">
                                                <p style="color:red;">
                                                    <?= isset($hovatennhanErr) ? $hovatennhanErr : '' ?></p>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="billing-info mb-20">
                                                ...
                                                <input type="text" name="sodienthoainhan"
                                                    value="<?= isset($sodienthoainhan) ? $sodienthoainhan : '' ?>">
                                                <p style="color:red;">
                                                    <?= isset($sodienthoainhanErr) ? $sodienthoainhanErr : '' ?></p>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="billing-info mb-20">
                                                ...
                                                <input type="text" name="diachinhan"
                                                    value="<?= isset($diachinhan) ? $diachinhan : '' ?>">
                                                <p style="color:red;"><?= isset($diachinhanErr) ? $diachinhanErr : '' ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="your-order-wrap gray-bg-4">
                                <div class="your-order-info-wrap">
                                    ...
                                    <div class="your-order-info order-total">
                                        <ul>
                                            <li>Thành tiền <span
                                                    id="vnp_thanhcong"><?= number_format($tongthanhtoan, 0, ',', '.') ?>đ</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="payment-method">
                                    <div class="pay-top sin-payment">
                                        <input id="payment-method-3" class="input-radio" type="radio" value="0"
                                            name="phuongthuctt" checked>
